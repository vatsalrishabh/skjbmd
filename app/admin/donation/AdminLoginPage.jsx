    ...
    try {
      if (!changeTheForm) {
        ...
        const response = await axios.post(
          `${process.env.NEXT_PUBLIC_BaseUrl}/api/auth/loginUser`,
          {
        ...
        if (step === 1) {
          ...
          await axios.post(
            `${process.env.NEXT_PUBLIC_BaseUrl}/api/auth/updatePassword`,
            {
              email: formData.email,
              role: formData.role,
            }
          ...
          await axios.post(
            `${process.env.NEXT_PUBLIC_BaseUrl}/api/auth/updatePasswordOtp`,
            {
              email: formData.email,
              role: formData.role,
